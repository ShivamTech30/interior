...
function Director() {
    ...
    const url = "https://cms.schoolscoop.co.in/Maitretech/items/faculty?status=published&fields=*.*"
            ...
            <div className="container-fluid">
                <div className="mb-5 row head_line">
                    <div className="col-lg-12">
                        <h4 className="pt-2"> WORD FROM THE DIRECTOR :
                ...
                <div className='container'>
                    <div className="row">
                        {/* <div className="mb-3 col-lg-7 col-md-7 col-sm-12 col-xs-12 name_drt">
                            <h3>
                        ...
                        <div className=" col-lg-4 col-md-4 col-sm-6 col-xs-12 drt_img"
                             >
                            <img
                        ...
                        <div className="col-lg-7 col-md-7 col-sm-6 col-xs-12">
                            <p className="ps-4">
                                ...
                                of the school to give civilized, knowledgeable and outstanding souls back to
                                the society, on receiving them as an innocent and tender minds. 
                                {/* {data?.data[1]?.message ? data?.data[1]?.message.slice(0, 100) : text}
                            <span onClick={()=>toggleReadMore()} className="read-or-hide">
                                {isReadMore ? "...read more" : " show less"}
                            </span> */}
                                {/* {data?.data[1]?.message} */}
